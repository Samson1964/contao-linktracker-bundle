...
$GLOBALS['TL_LANG']['tl_linktracker_items']['viaLegacy'] = array('Über die alte Adresse', 'Der Aufruf kam über bundles/contaolinktracker/go.php statt über /linktracker/{id}');
